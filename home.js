  ...
  template: `
		<div class="row">
			<div class="col-lg-8">
				...
				<p><a href="#history" data-toggle="collapse">Read More</a></p>
				<div id="history" class="collapse">
					...
					<p>In the West, the idea that government should be open to public scrutiny and susceptible to public
						opinion dates back at least to the time of the Enlightenment, when many philosophers made an
						attack on absolutist doctrine of state secrecy, a core part of their intellectual project. The
						passage of formal legislative instruments to this end can also be traced to this time with
						Sweden, for example, (which then included Finland as a Swedish-governed territory) enacting free
						press legislation as part of its constitution (Freedom of the Press Act, 1766). This approach,
						and that of the philosophes more broadly, is strongly related to recent historiography on the
			...
			<div class="col-lg-4">
				<img class="img-responsive" src="images/tgif-home.jpg" alt="TGIF Home">
			</div>
		</div>
	`,
});
